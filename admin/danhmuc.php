...
if (isset($_GET['search_iddm'])) {
    $search_iddm = $_GET['search_iddm'];
    $sql = "SELECT * FROM danhmuc WHERE IDDM LIKE '%$search_iddm%'";
} else {
...
<script>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Chi tiết danh mục dịch vụ<small> </small>
                        </h1>
                        <form action="" method="GET" class="form-inline">
                                <div class="form-group">
                                    <label for="search_iddm">Nhập ID danh mục cần tìm:</label>
                                    <input type="text" class="form-control" id="search_iddm" name="search_iddm">
                                </div>
        ...
        <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										while($row = mysqli_fetch_array($re)) {
                                            ...
                                            echo "<td>" . $row['IDDM'] . "</td>";
                                            echo "<td>" . $row['LOAIDM'] . "</td>";
                                            echo "<td>" . $row['IDNCC'] . "</td>";
                                            echo "<td>" . $row['IDKS'] . "</td>";
                                            echo "<td>
                                                    <a href='edit_danhmuc.php?id=$id'class='btn btn-success'>Sửa</a> | 
                            ...
                            <a href="themdanhmuc.php" class="btn btn-primary">Thêm danh mục dịch vụ</a>
                        </div>
                            </div>
    ...
    function confirmDelete(id) {
        if (confirm("Bạn có muốn xóa thông tin này không?")) {
            window.location.href = 'delete_danhmuc.php?id=' + id;
        }
    }
</script>
