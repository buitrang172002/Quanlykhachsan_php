...
if (isset($_GET['search_idkh'])) {
    $search_idkh = $_GET['search_idkh'];
    $sql = "SELECT * FROM ttkhachhang WHERE IDkh LIKE '%$search_idkh%'";
} else {
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Chi tiết các khách hàng<small> </small>
                        </h1>
                        <form action="" method="GET" class="form-inline">
                                <div class="form-group">
                                    <label for="search_idkh">Nhập ID khách hàng cần tìm:</label>
                                    <input type="text" class="form-control" id="search_idkh" name="search_idkh">
                                </div>
                ...
                <tbody>
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($re)) {
                            ...
                            echo "<td>
                                    <a href='edit_khachhang.php?id=$id' class='btn btn-success'>Sửa</a> | 
