			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Bản tin<small> Bảng điều khiển</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Gửi thư tin tức cho người theo dõi</h3>
						<?php
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<div class="modal-body">
										<div class="form-group">
										  <label for="comment">Soạn thư</label>
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
													...
													<td>".$row['cdate']."</td>
													<td>".$row['approval']."</td>
													<td><a href=newsletter.php?eid=".$id ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i>Tìm kiếm</button></td>
