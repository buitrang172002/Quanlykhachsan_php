        ...
        <a href="baocaothang.php" class="btn btn-primary">Thống kê dữ liệu theo tháng</a>
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Danh sách thống kê trong tuần<small> </small>
                        </h1>
                    </div>
                    <!-- Advanced Tables -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tổng số dịch vụ sử dụng trong tuần</th>
                                            <th>Tổng doanh thu trong tuần</th>											
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <?php
                                        $sql_kh_datphong = "SELECT * FROM datphong 
                                                            WHERE DATE(NGAYDAT) BETWEEN CURDATE() - INTERVAL 1 WEEK AND CURDATE() - INTERVAL 1 DAY";
