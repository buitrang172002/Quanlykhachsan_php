    ...
    outline: none;
        ...
        <body>
                <div class="container">
                    ...
                    <h2>Gia hạn ngày trả</h2>
                    <form action="update_datphong.php" method="POST">
                        <input type="hidden" name="id" value="<?php echo $row['IDDP']; ?>">
                        <div class="form-group">
                            <label for="idp">ID phòng:</label>
                            <input type="text" name="idp" value="<?php echo $row['IDPHONG']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="ngaytra">Ngày trả:</label>
                            <?php
                             
                                $timestamp = strtotime($row['NGAYTRA']);
                              
                                $formattedDate = date('Y-m-d\TH:i', $timestamp);
                            ?>
                            <input type="datetime-local" name="ngaytra" value="<?php echo $formattedDate; ?>">
                        </div>
