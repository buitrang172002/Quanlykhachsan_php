...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM ttkhachhang WHERE IDKH = $id";
    ...
    outline: none;
        ...
        <body>
            ...
            <img src="imag/nen.jpg" class="hinhnen">
                ...
                <hr>
                <form action="update_khachhang.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $row['IDKH']; ?>">
                    
                    <div class="form-group">
                        <label for="tenks">Tên khách hàng:</label>
