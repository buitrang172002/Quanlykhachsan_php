...
if (isset($_GET['search_idks'])) {
    $search_idks = $_GET['search_idks'];
    $sql = "SELECT * FROM khachsan WHERE IDKS LIKE '%$search_idks%'";
} else {
...
<script>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Chi tiết các khách sạn<small> </small>
                        </h1>
                         <!-- Search form -->
                            <form action="" method="GET" class="form-inline">
                                <div class="form-group">
                                    <label for="search_idks">Nhập ID khách sạn cần tìm:</label>
                                    <input type="text" class="form-control" id="search_idks" name="search_idks">
                                </div>
        ...
        <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Email</th>
                                        <th>Fax</th>
                                        <th style="width:205px;">Địa chỉ</th>
                                        <th>Quản lý</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($re)) {
                                        ...
                                        // Display other table columns as needed
                                        echo "<td>" . $row['IDKS'] . "</td>";
                                        ...
                                        echo "<td>
                                                <a href='edit_khachsan.php?id=$id'class='btn btn-success'>Sửa</a> | 
                            ...
                            <a href="themkhachsan.php" class="btn btn-primary">Thêm khách sạn</a>
                        </div>
                            </div>
    ...
    function confirmDelete(id) {
        if (confirm("Bạn có muốn xóa thông tin này không?")) {
            window.location.href = 'delete_khachsan.php?id=' + id;
        }
    }
</script>
