...
if (isset($_GET['search_idphong'])) {
    $search_idphong = $_GET['search_idphong'];
    $sql = "SELECT * FROM phong WHERE IDphong LIKE '%$search_idphong%'";
} else {
    ...
    <a href="#" onclick="confirmLogout();">
        ...
        <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="phong.php"><i class="fa fa-qrcode"></i> Quản lý dịch vụ</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Chi tiết phòng khách sạn<small> </small>
                        </h1>
                        <form action="" method="GET" class="form-inline">
                                <div class="form-group">
                                    <label for="search_idphong">Nhập ID phòng khách sạn cần tìm:</label>
                                    <input type="text" class="form-control" id="search_idphong" name="search_idphong">
                                </div>
    ...
    <div class="panel-body">
        <div class="table-responsive table-striped-body">
                ...
                <tbody>
                    <?php
                        while ($row = mysqli_fetch_array($re)) {
                            ...
                            echo "<td>" . $row['IDKS'] . "</td>";
                            echo "<td>
                                    <a href='edit_phong.php?id=$id' class='btn btn-success'>Sửa</a> | 
            ...
            <div class="btn-container">
                <a href="themphong.php" class="btn btn-primary">Thêm phòng khách sạn</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    function confirmDelete(id) {
        if (confirm("Bạn có muốn xóa thông tin này không?")) {
            window.location.href = 'delete_phong.php?id=' + id;
        }
    }
</script>


                    <!--End Aphonganced Tables -->
                </div>
