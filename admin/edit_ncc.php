...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM nhacc WHERE IDNCC = $id";
    $result = mysqli_query($con, $query);

    if (mysqli_num_rows($result) == 1) {
        $row = mysqli_fetch_assoc($result);

        // Display a form with the data for editing
        // You can customize the form based on your requirements
        ?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
    ...
    outline: none;
        ...
        <body>
            ...
            <img src="imag/nen.jpg" class="hinhnen">
                ...
                <hr>
                <form action="update_ncc.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $row['IDNCC']; ?>">
