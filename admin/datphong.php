...
<script>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Thông tin đặt phòng<small> </small>
                        </h1>
                    </div>
                </div> 
			<?php
        ...
        <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										...
										while($row = mysqli_fetch_array($re)) {
                                            ...
                                            echo "<td>
                                            <a href='add_dichvu.php?id=$id'>Add</a> 
                                           
                                            </td>";
                                            echo "<td>
                                           
                                            <a href='giahanngay.php?id=$id'>Gia hạn ngày</a> 
                                            </td>";
                                            echo "<td>
                                           
                                            <a href=print.php?pid=".$id ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button>
                                            </td>";
                                            echo "<td>
                            ...
                            <a href="datphongdv.php" class="btn btn-primary">Đặt phòng</a>
                        </div>
                               
            

                                <h2>Thông tin dịch vụ khách sạn:</h2>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											<th>ID dịch vụ</th>
    ...
    function confirmDelete(id) {
        if (confirm("Bạn có muốn xóa thông tin này không?")) {
            window.location.href = 'delete_ttdatphong.php?id=' + id;
        }
    }
</script>
                    <!--End Advanced Tables -->
